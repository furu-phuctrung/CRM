...
@include('modal.modaluploadcustomer')
												...
												<div class="m-portlet__head-tools">
													<ul class="m-portlet__nav">
														<div class="m-portlet__nav-item">
												 				<a class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill" data-toggle="modal" data-target="#uploadkhach"><span><i class="la la-user-plus"></i><span> Upload Khách Hàng </span></span></a>
											 				</div>
													</ul>
												</div>
											</div>
                   ...
                   <table class="m-datatable__table" style="display: block; min-height: 300px; overflow-x: auto;">
                  		...
                  		<tbody style="" class="m-datatable__body">
                  			 ...
                  			 <tr data-row="0" class="m-datatable__row m-datatable__row--even m-datatable__row--subtable-expanded m-datatable__row--hover" style="border-bottom: 1px solid #f0f3ff;">
													 ...
													 <td class="m-datatable__cell--center m-datatable__cell m-datatable__cell--check" data-field="RecordID"><span style="width: 50px;"><label class="m-checkbox m-checkbox--single m-checkbox--solid m-checkbox--brand"><input type="checkbox" name="RecordID" value="" data-id=""><span></span></label></span></td>
																			...
																			<div class="m-widget19__content" style="margin: 0;">
																				 <div class="m-widget19__header" >
																					 <div class="m-widget19__user-img">
																						 <a href="#" title="Edit details" data-toggle="modal" data-target="#m_modal_5" type="submit" class="send-btn" name="RecordID" value="" data-id="">
                  					...
                  					<td class="m-datatable__cell--sorted m-datatable__cell" data-field="FirstName"><span style="width: 132px;"><a href="#" title="Edit details" data-toggle="modal" data-target="#m_modal_5" type="submit" class="send-btn" name="RecordID" value="" data-id=""></a></span></td>
                  					<td data-field="Company" class="m-datatable__cell"><span style="width: 130px;"></span></td>
                  					<td data-field="Email" class="m-datatable__cell"><span style="width: 142px;"></span></td>
                  					<td data-field="Phone" class="m-datatable__cell"><span style="width: 140px;text-align: center;"><span class="m-badge  m-badge--success m-badge--wide" style="/*! background-color: ; */"></span></span></span></td>
														<td data-field="Actions" class="m-datatable__cell"><span style="overflow: visible; position: relative; width: 179px;">
												    					<a href="#" class="m-portlet__nav-link btn m-btn m-btn--icon m-btn--icon-only m-btn--pill"  data-toggle="modal" data-target="#m_modal_4"  style="height: 19px;"></a>
										      			</span>
														</td>
                  					<td data-field="Type" class="m-datatable__cell"><span style="width: 126px;text-align: center;"><span class="m-badge m-badge--danger m-badge--dot"></span>&nbsp;<span class="m--font-bold m--font-danger"></span></span></td>
														<td data-field="Type" class="m-datatable__cell"><span style="width: 112px;text-align: center;"><span class="m-badge m-badge--danger m-badge--dot"></span>&nbsp;<span class="m--font-bold m--font-danger"></span></span></td>
                  			 </tr>
                  		</tbody>
																...
																<form class="m-form m-form--fit m-form--label-align-right" >
																	...
																	<div class="col-md-12 col-lg-12 col-xl-6">
																		...
																		<!--begin:: Widgets/Stats2-2 -->
																												          													...
																												          													<!-- start	modal upload khách hàng			 -->
																																														<div class="modal fade show" id="uploadkhachhang" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="display: block;">
																																																<div class="modal-dialog modal-lg" role="document">
																																																	<div class="modal-content">
																																																		<div class="modal-header">
