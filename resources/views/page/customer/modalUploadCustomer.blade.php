...
<div class="modal fade" id="modalUploadCustomer" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="display: none;" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="m-form m-form--fit m-form--label-align-right" action="{{route('customer.postUploadCustomer')}}" enctype="multipart/form-data" method="POST">
                @csrf
                <div class="m-portlet__body">
                  ...
                  <div class="form-group m-form__group">
                    ...
                    <div class="custom-file">
                      <input type="file" name="customer" class="custom-file-input btn m-btn--pill m-btn--air btn-primary btn-block" required="true" >
