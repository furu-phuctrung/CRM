...
@section('content')
	...
	@if(Auth::user()->google2fa_old_active == '0')
<div class="m-content">
						<div class="row">
								...
								<div class="m-portlet m-portlet--full-height m-portlet--tabs  ">
									...
									<div class="tab-content">
										<div class="tab-pane active" id="m_user_profile_tab_1">
											<form class="m-form m-form--fit m-form--label-align-right" method="POST" action="{{ route('enable2fa') }}">
                        @csrf
                          ...
                          <p style="text-align: center;">You must set up your Google Authenticator app before continuing. You will be unable to login otherwise</p>
													<div class="form-group m-form__group row" >
														...
														<div class="col-4">
															<input class="form-control m-input" type="text" value="" name="verify-code" placeholder=" VD: 905124" required autofocus>
