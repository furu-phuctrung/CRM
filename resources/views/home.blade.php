												...
												<div class="m-portlet__head-tools">
													<ul class="m-portlet__nav">
														<div class="m-portlet__nav-item">
															@if(Auth::user()->havePermission('addnewcustomer'))
									...
									<ul class="m-portlet__nav">
										<div class="m-portlet__nav-item">
											<div class="col-lg-12">
												<div class="row">
												<div class="col-lg-4">
												<a class="btn btn-info" data-toggle="modal" id="btn-modalShareNewCustomer" data-target="#modalShareNewCustomer"><span><i class="fa fa-share-square"></i><span> Chuyển Khách  </span></span></a>
												</div>
											</div>
											</div>
											</div>
				                  	 ...
				                  	 <thead class="m-datatable__head">
				                  			 <tr class="m-datatable__row">
																	 ...
																	 <th class="m-datatable__cell m-datatable__cell--sort"><span style="width: 35px;" ></span></th>
																		...
																		<th class="m-datatable__cell m-datatable__cell--sort"><span style="width: 150px;">Phone</span></th>
																		<th class="m-datatable__cell m-datatable__cell--sort"><span style="width: 300px;">Mô Tả</span></th>
																		<th class="m-datatable__cell m-datatable__cell--sort"><span style="width: 150px;text-align: center;">Trạng Thái</span></th>
				                  					<th class="m-datatable__cell m-datatable__cell--sort"><span style="width: 150px;text-align: center;">Nhóm Khách</span></th>
				                  					<th class="m-datatable__cell m-datatable__cell--sort"><span style="width: 150px;text-align: center;">Nguồn Khách</span></th>
																		<th class="m-datatable__cell m-datatable__cell--sort"><span style="width: 200px;">Email</span></th>
																 </tr>
				                  		</thead>
				                  		...
				                  		<tbody style="" class="m-datatable__body">
											...
											@foreach($datas as $index => $data)
												<tr data-row="0" class="m-datatable__row m-datatable__row--even m-datatable__row--subtable-expanded m-datatable__row--hover" style="border-bottom: 1px solid #f0f3ff;">
													...
													<td class="m-datatable__cell--sorted m-datatable__cell" ondblclick="this.contentEditable=true;this.className='m-datatable__cell--sorted m-datatable__cell changename';" onblur="this.contentEditable=false;this.className='m-datatable__cell--sorted m-datatable__cell changename';" contenteditable="false" data-fullname="{{ $data->customer_name}}"><span style="width: 200px;"><a id="changename" href="https://crm.longdienland.com/customer/{{$data->ID}}" title="Edit Customer details">{{ $data->customer_name}}</span></td>
														<td class="m-datatable__cell"><span style="width: 150px;">{{$data->phone}}</span></td>
													...
													<td class="m-datatable__cell">
														<span style="width: 170px;text-align: center;">
													...
													<td class="m-datatable__cell"><span style="width: 150px;text-align: center;"><span class="m-badge m-badge--danger m-badge--dot"></span>&nbsp;<span class="m--font-bold m--font-danger">{{$data->duan}}</span></span></td>
													<td class="m-datatable__cell"><span style="width: 150px;text-align: center;"><span class="m-badge m-badge--danger m-badge--dot"></span>&nbsp;<span class="m--font-bold m--font-danger">@if($data->customer_resources != '' ){{$data->customer_resources}} @else N/A @endif</span></span></td>
