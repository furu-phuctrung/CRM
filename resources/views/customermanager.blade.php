			...
			<div class="m-portlet m-portlet--mobile">
									...
									<div class="m-portlet__body">
										<div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
											<form action="{{route('searchcustomermanager')}}" method="GET">
												@csrf
				                  	 ...
				                  	 <thead class="m-datatable__head">
				                  			 <tr class="m-datatable__row">
																	 ...
																	 <th class="m-datatable__cell m-datatable__cell--sort"><span style="width: 35px;" ></span></th>
																		...
																		<th class="m-datatable__cell m-datatable__cell--sort"><span style="width: 200px;text-align: center;">Trạng Thái</span></th>
																		<th class="m-datatable__cell m-datatable__cell--sort"><span style="width: 200px;">Người Phụ Trach</span></th>
				                  		...
				                  		<tbody style="" class="m-datatable__body">
											...
											@foreach($datas as $data)
												<tr data-row="0" class="m-datatable__row m-datatable__row--even m-datatable__row--subtable-expanded m-datatable__row--hover" style="border-bottom: 1px solid #f0f3ff;">
													...
													<td class="m-datatable__cell"><span style="width: 200px;">{{$data->username}}</span></td>
